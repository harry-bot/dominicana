          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <ul
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 rounded border-[.5px] border-body-color/20 bg-primary py-4 px-6 duration-300 ${
                    navbarOpen
                ...
                >
                    <li className="group relative">
                      <div
                        className={`submenu relative top-full left-0 rounded-md bg-primary transition-[top] duration-300 group-hover:opacity-100`}
                      >
                        <Link
                          href="/en"
